...
#+RESULTS:
#+begin_example
 [1] ".GlobalEnv"        "package:forcats"   "package:dplyr"
 [4] "package:purrr"     "package:tidyr"     "package:tibble"
 [7] "package:ggplot2"   "package:tidyverse" "package:readr"
[10] "ESSR"              "package:stats"     "package:graphics"
[13] "package:grDevices" "package:utils"     "package:datasets"
[16] "package:stringr"   "package:httr"      "package:methods"
...
- We use the algorithm implemented in the imaginatively named ~e1071~
  ...
  [11] "package:forcats"          "package:dplyr"           
  [13] "package:purrr"            "package:tidyr"           
  [15] "package:tibble"           "package:ggplot2"         
  [17] "package:tidyverse"        "package:readr"           
  [19] "ESSR"                     "package:stats"           
  [21] "package:graphics"         "package:grDevices"       
  [23] "package:utils"            "package:datasets"        
  [25] "package:stringr"          "package:httr"            
...
- The ~sms_classifier~ variable now contains a ~naiveBayes~ classifier
  ...
  2) the data structure of the model
     1) the probabilities for two words from the "spam" and "ham" pile
  #+begin_src R
