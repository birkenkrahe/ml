...
1) How is the usual ML workflow altered for a message spam filter?
   ...
   #+end_notes
2) How many features does the raw data set (SMS Spam Collection) have? How many  will the cleaned data set have?
   #+begin_notes
...
* TODO Week 11: Finish Spam Filter & Start "Regression"

** [[c:/Program Files/Emacs/emacs-28.2/bin/][RTextTools example]] for the UCI breast cancer data
