...
* TODO Week 10: Naive Bayes algorithm and case study
#+attr_latex: :width 400px
...
* TODO Results: Test 3 and Tsunami of assignments
#+attr_latex: :width 400px
[[../img/mlTestBox.png]]
...
* TODO Review: Simple Naive Bayes
#+attr_html: :width 300px
...
7) What's is the joint probability of the events "being home" and
   ...
   exclusive. 
   #+end_notes
8) What does the condition probability (or likelihood) of the events
...
* TODO Week 16: Case study: breast cancer data
* TODO What next?
