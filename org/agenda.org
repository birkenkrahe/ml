...
* NEXT Week 11: Naive Bayes Spam Filter & "Regression"
#+attr_latex: :width 400px
...
- If we don't finish with a session, save your data from now on:
  ...
  #+RESULTS:
  : -rwx------+ 1 Birkenkrahe LYONNET+Group(513) 1935366 Mar 22 10:20 .RData

- Now: cntinue with your practice file ~5_naive_bayes_practice.org~
  after adding the next (and final) chapters from here: bit.ly/nb_final
  
* TODO Introduction to linear regression with examples


* TODO Week 12: k-means clustering
...
* TODO Week 14: Artificial Neural networks (ANN)
* TODO Week 15: ANN case + Projects I
* TODO Week 16: Projects II and Summary 
* TODO What next?
