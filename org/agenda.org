...
* IN PROGRESS Week 11: Naive Bayes Spam Filter & "Regression"
#+attr_latex: :width 400px
...
- [ ] *Test 4* is live from 2.30 pm 28-March: full points if you submit by
...
* DONE In the meantime: the charade continues
...
* DONE DataCamp assignments update
#+attr_latex: :width 400px
...
* DONE ELIZA - "Fake Rogerian Therapist"
#+attr_latex: :width 400px
...
* TODO Lex Fridman (MIT) interviews Sam Altman (OpenAI)
#+attr_latex: :width 400px
#+caption: Lex Fridman (MIT) and Sam Altman (OpenAI) 26-March-2023
[[../img/altman.png]]

- [[https://youtu.be/L_Guz73e6fw][Link to the > 2 hr interview (YouTub* TODO Bonus points for job fair experience report!
#+attr_latex: :width 400px
...
* TODO Week 12: Regression case study
#+attr_latex: :width 400px
