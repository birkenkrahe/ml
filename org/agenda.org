...
- Zip all materials or use the Org-mode file and upload them to Canvas
...
Tue:
- Error measures: residuals, \alpha and p-value
- Null hypothesis (predictors don't predict anything)
- p-hacking: rampant issue in clinical trials

Thu: Just do it!

** ML - too large for its own good?
#+attr_latex: :width 400px
...
- Let me know what you liked and what you didn't like: fill in the
  survey ([[https://lyon.instructure.com/courses/1041/external_tools/163]["CourseEval"@Canvas]]) by May 4, 5:59 pm (*bonus points*)

*** ML Careers

- [[https://link.medium.com/pLGMURvz1yb][How To Improve Your Job Search With 4 + 1 Quick Tips]] (I don't
  believe in these but you should be aware of them anyway):
...
- To achieve any goal you need a system that supports it: the goal is
  a burning ambition, the system is an action framework.

- For advancing in data science, this includes:
  1) *One-off:* continue completing new DataCamp courses (until July 6),
     and thereafter explore free course alternatives (there are many)
  2) *Routine:* practice daily on ALL completed DataCamp courses: 5
     minutes a day will keep the doctor away!
  3) *Routine:* read recent papers on regression applications beginning
     with literature reviews [[https://pdfs.semanticscholar.org/5d7c/b4891c73ad8ec642e4d8ab2220bb52a64086.pdf][like this one]]. Look for applications.
...
** DataCamp review questions: decision trees
#+attr_latex: :width 400px
