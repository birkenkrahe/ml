...
*Housekeeping*
- [ ] Submit your job fair experience by tonight for extra credit
- [ ] Test 5 is online - for full points complete by end of this week
- [ ] Only 65% completed the last DataCamp assignment!?

*Topics*
- [ ] Short introduction to simple and multiple linear regression
- [ ] Case study: Challenger risk analysis
- [ ] Case study: Predicting medical expenses

*Outlook*
- [ ] [[https://lyon.instructure.com/courses/1021/assignments/9904][3rd sprint review for projects ("abstract") due April 21]]
- [ ] Week 14: Artificial Neural Networks (unsupervised learning)
- [ ] Final presentations Tue 25-Apr, Thu 27-Apr, Tue 2-May ([[https://lyon.instructure.com/courses/1021/pages/sign-up-for-final-presentations][sign up]])

* TODO Regression case study "Star Surgeon"
#+attr_latex: :width 400px
#+caption: Sci-Fi novel cover "Star Surgeon" by James White (1963)
[[../img/star_surgeon.jpg]]

* TODO Further study: regression at DataCamp
#+attr_latex: :width 300px
...
* TODO Test review questions: regression (Wed)
#+attr_latex: :width 400px
#+caption: Source: Wikipedia ROC entry
[[../img/Roc_curve.svg]]
...
* TODO Week 14: Artificial Neural Networks
